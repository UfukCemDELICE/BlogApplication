...
public class BlogApiImpl implements IBlogApi {
    ...
    //http://localhost:2222/api/v1/blog/create
    //CREATE
    @Override
    ...
    //http://localhost:2222/api/v1/blog/list
    //LIST
    @Override
    ...
    //http://localhost:2222/api/v1/blog/find/1
    //FIND
    @Override
    ...
    //http://localhost:2222/api/v1/blog/update/1
    //UPDATE
    @Override
    ...
    //http://localhost:2222/api/v1/blog/delete/1
    //DELETE
    @Override
